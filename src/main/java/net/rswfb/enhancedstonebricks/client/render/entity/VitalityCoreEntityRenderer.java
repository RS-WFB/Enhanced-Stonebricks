...
public class VitalityCoreEntityRenderer extends CoreEntityRenderer {
    public VitalityCoreEntityRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }
    ...
    public class ClientEventHandler {
        ...
        public static void onClientEvent(FMLClientSetupEvent event) {
            ...
            event.enqueueWork(()->{
                EntityRenderers.register(ModEntityTypes.VITALITY_CORE_ENTITY.get(), VitalityCoreEntityRenderer::new);
            });
        }
    }
}
