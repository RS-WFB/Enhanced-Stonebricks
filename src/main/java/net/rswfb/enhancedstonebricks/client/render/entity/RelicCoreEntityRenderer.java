...
public class RelicCoreEntityRenderer extends CoreEntityRenderer {
    public RelicCoreEntityRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    @Override
    public ResourceLocation getTextureLocation(CoreEntity pEntity) {
        return new ResourceLocation(ExampleMod.MODID, "textures/entity/core_of_relic.png");
    }
    ...
    public class ClientEventHandler {
        ...
        public static void onClientEvent(FMLClientSetupEvent event) {
            ...
            event.enqueueWork(()->{
                EntityRenderers.register(ModEntityTypes.RELIC_CORE_ENTITY.get(), RelicCoreEntityRenderer::new);
            });
        }
    }
}
