...
public class DesertCoreEntityRenderer  extends CoreEntityRenderer {
    public DesertCoreEntityRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    @Override
    public ResourceLocation getTextureLocation(CoreEntity pEntity) {
        return new ResourceLocation(ExampleMod.MODID, "textures/entity/core_of_desert.png");
    }
    ...
    public class ClientEventHandler {
        ...
        public static void onClientEvent(FMLClientSetupEvent event) {
            ...
            event.enqueueWork(()->{
                EntityRenderers.register(ModEntityTypes.DESERT_CORE_ENTITY.get(), DesertCoreEntityRenderer::new);
            });
        }
    }
}
