...
public class OceanCoreEntityRenderer extends CoreEntityRenderer {
    public OceanCoreEntityRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    @Override
    public ResourceLocation getTextureLocation(CoreEntity pEntity) {
        return new ResourceLocation(ExampleMod.MODID, "textures/entity/core_of_ocean.png");
    }
    ...
    public class ClientEventHandler {
        ...
        public static void onClientEvent(FMLClientSetupEvent event) {
            ...
            event.enqueueWork(()->{
                EntityRenderers.register(ModEntityTypes.OCEAN_CORE_ENTITY.get(), OceanCoreEntityRenderer::new);
            });
        }
    }
}
