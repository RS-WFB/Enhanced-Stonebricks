...
public class SoulCoreEntityRenderer extends CoreEntityRenderer {
    public SoulCoreEntityRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    @Override
    public ResourceLocation getTextureLocation(CoreEntity pEntity) {
        return new ResourceLocation(ExampleMod.MODID, "textures/entity/core_of_soul.png");
    }
    ...
    public class ClientEventHandler {
        ...
        public static void onClientEvent(FMLClientSetupEvent event) {
            ...
            event.enqueueWork(()->{
                EntityRenderers.register(ModEntityTypes.SOUL_CORE_ENTITY.get(), SoulCoreEntityRenderer::new);
            });
        }
    }
}
