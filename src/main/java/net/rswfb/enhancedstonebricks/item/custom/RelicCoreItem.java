...
public class RelicCoreItem extends CoreItem {
    public RelicCoreItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        CoreEntity coreentity = new CoreEntity(ModEntityTypes.RELIC_CORE_ENTITY.get(), pLevel);
