...
public class SoulCoreItem extends CoreItem {
    public SoulCoreItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        CoreEntity coreentity = new CoreEntity(ModEntityTypes.SOUL_CORE_ENTITY.get(), pLevel);
